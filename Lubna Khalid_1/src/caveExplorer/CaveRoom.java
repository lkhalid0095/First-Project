...
public class CaveRoom {
	...
	//the rooms are organized by the directions, 'null' signifies no room/door in that direction.
	...
	public CaveRoom(String description) {
		...
		//diference between defaultCOntents and content is "contents" becomes an 'X' when you are 
		//inside the room, when you leave, it goes back to defaultContents.
	 ...
	 * "There are no doors, you are trapped here."
	 */
	...
	public void setDirections() {
		...
		if(!doorFound) {
			directions += "There is no way out. You are trapped here, like I'm trapped in my thoughts.";
		}
	...
	public static String toDirection(int dir){
		String arr[] = {"the North","the South", "the East", "the West"};
		return arr[dir];
	}
	...
	public void interpretInput(String input) {
		...
		//(or,if you must, dont sue more than 1)
	...
	/**
	 * This will be where your group sets up all the caves and all connections.
	 */
	public static void setUpCaves() {
		//ALL OF THIS CODE CAN BE CHANGED.
		//1. Decide how big your caves should be.
		CaveExplorer.caves = new CaveRoom[5][5];
		//2. Populate with caves and a default descriptions. Hint: When starting, use coordinates.(helps debugging) 
